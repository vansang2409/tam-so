const FAQ = [
  ...
  { q: 'Dữ liệu của tôi có bị lưu hay gửi đi đâu không?', a: 'Các công cụ chiêm nghiệm vẫn tính ngay trên trình duyệt: họ tên/ngày sinh và lịch sử/lá yêu thích hiện lưu cục bộ (localStorage) cho đến khi có tính năng đồng bộ riêng. Nếu bạn chọn đăng nhập, email và phiên đăng nhập được xử lý qua Supabase Auth; Tam Sở không tự dựng máy chủ riêng để đọc kết quả của bạn.' },
  ...
  { q: 'Có cần đăng nhập hay trả phí không?', a: 'Không bắt buộc. Các công cụ chính vẫn dùng miễn phí khi chưa đăng nhập; tài khoản Supabase chỉ là lớp tuỳ chọn để mở đường cho lưu/sync cá nhân sau này.' },
