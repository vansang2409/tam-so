const FAQ = [
  ...
  { q: 'Dữ liệu của tôi có bị lưu hay gửi đi đâu không?', a: 'Các công cụ chiêm nghiệm vẫn tính ngay trên trình duyệt. Khi chưa đăng nhập, họ tên/ngày sinh, lịch sử và lá yêu thích lưu cục bộ (localStorage). Nếu bạn đăng nhập và bấm “Lập hồ sơ”, Hồ sơ tổng hợp được đồng bộ vào bảng public.profiles của Supabase với RLS chỉ cho chính tài khoản đó đọc/sửa; email và phiên đăng nhập do Supabase Auth xử lý.' },
  ...
  { q: 'Có cần đăng nhập hay trả phí không?', a: 'Không bắt buộc. Các công cụ chính vẫn dùng miễn phí khi chưa đăng nhập; tài khoản Supabase chỉ giúp lưu Hồ sơ tổng hợp qua nhiều thiết bị, còn các phần sync khác sẽ mở rộng sau.' },
