    ...
    <>
      ...
      <section className="wrap py-8">
        ...
        <div className="panel p-[26px] max-w-[900px] mx-auto">
          ...
          <p><b>🔢 Thần số học:</b> <a href="https://www.numerology.com/articles/your-numerology-chart/core-numbers-numerology/" target="_blank" rel="noopener">Numerology.com — Core Numbers</a> & <a href="https://www.numerology.com/articles/your-numerology-chart/life-path-number-meanings/" target="_blank" rel="noopener">Life Path</a> (Pythagorean) · Đỉnh cao & Thử thách: <a href="https://www.worldnumerology.com/numerology-pinnacles/" target="_blank" rel="noopener">World Numerology</a>.</p>
          <p><b>☯️ Tử vi · Can Chi:</b> <a href="https://wiki.batdongsan.com.vn/wiki/thien-can-dia-chi-783653" target="_blank" rel="noopener">Wiki Batdongsan</a> · <a href="https://vi.wikipedia.org/wiki/L%E1%BB%A5c_th%E1%BA%ADp_hoa_gi%C3%A1p" target="_blank" rel="noopener">Lục thập hoa giáp</a> · can chi ngày (mốc 1/3/2000 = Mậu Ngọ, vanhoavaphattrien.vn) · <a href="https://vi.wikipedia.org/wiki/Gi%E1%BB%9D_ho%C3%A0ng_%C4%91%E1%BA%A1o" target="_blank" rel="noopener">Giờ hoàng đạo</a> · tam hợp/tứ hành xung (bachhoaxanh, mytour) · đổi âm lịch: <a href="https://www.informatik.uni-leipzig.de/~duc/amlich/" target="_blank" rel="noopener">Hồ Ngọc Đức</a>.</p>
