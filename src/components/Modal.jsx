...
export default function Modal({ open, onClose, children }) {
  ...
  return (
    <div onClick={e => { if (e.target === e.currentTarget) onClose() }}
      className="fixed inset-0 z-[60] flex items-center justify-center p-5 bg-[#05040e]/75 backdrop-blur-sm animate-fade">
      <div className="relative w-full max-w-[520px] p-[30px] rounded-[18px] shadow-soft border border-gold/30"
        style={{ background: 'linear-gradient(160deg,#191338,#221a47)' }}>
