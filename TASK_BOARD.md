...
| DC14 | Lư hương + ống xăm THẬT hơn nữa — 2 lần nâng cấp CSS (v3.79/v3.80, v3.83) chủ dự án vẫn phản hồi "xấu quá" | UI/Art | Med | Blocked | CSS vẽ tay đã chạm giới hạn — cần ảnh thật (PNG nền đơn giản, tôi xử lý trong suốt) như cách làm 11 ảnh cảnh chùa; chờ chủ dự án quyết định có muốn tự tạo ảnh không |
