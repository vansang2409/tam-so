...
| DC11 | Lư hương + ống xăm nhìn thật hơn (phản hồi "xấu quá") — KHÔNG có công cụ tạo ảnh + 3D thật đã chủ động không dùng → nâng cấp bằng CSS (radial-gradient lệch tâm giả độ cong, đốt tre, vân gỗ tự nhiên) | UI/Art | Med | Done (v3.83) | verify computed style đúng qua dev server; CHƯA tự xem được bằng mắt (screenshot môi trường này bị treo) — chờ chủ dự án tự mở xem & phản hồi tiếp |
