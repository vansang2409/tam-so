...
- **Lá số Tử Vi (Tử Vi Đẩu Số):** nhập ngày–giờ sinh → **an sao** lá số **12 cung** (lưới 4×4 truyền thống): an Mệnh/Thân, định **Cục**, an đủ **14 chính tinh** (chùm Tử Vi + Thiên Phủ), **Tứ Hóa** (Lộc/Quyền/Khoa/Kỵ), **lục cát – lục sát**, Lộc Tồn, Thiên Mã, đào hoa… vòng **Tràng Sinh**, và **đại hạn**; thêm **vận hạn năm nay** (đại hạn / tiểu hạn / lưu niên Thái Tuế), **cách cục Mệnh** (Tử Phủ Vũ Tướng · Sát Phá Lang · Cơ Nguyệt Đồng Lương · Cự Nhật) và **tam phương tứ chính**. Chạm từng cung để xem luận sao & cung; lưới **co giãn/cuộn ngang trên điện thoại**. Tự phát hiện **cách cục nổi tiếng** (Tử Phủ đồng cung, Lộc Mã giao trì, Khôi Việt, Tả Hữu, Xương Khúc, Nhật Nguyệt, Tham Hỏa/Linh, Mã đầu đới kiếm…) và **độ sáng đầy đủ Miếu/Vượng/Đắc/Bình/Hãm (M·V·Đ·B·H)** cho cả 14 chính tinh × 12 cung — nguồn tracuutuvi.com (Gia Cát Trường Phong), phần Miếu **khớp 100% với bảng HOROS** đã kiểm; có dị bản giữa các phái nên chỉ để **tham khảo** (Hãm = sao yếu cần hỗ trợ, không phải điềm xấu tất định). Kèm sáng/tối Nhật–Nguyệt. **Lưu lịch sử lá số, tải ảnh PNG, In/Lưu PDF**. Cung Mệnh + chính tinh cũng hiện trong **Hồ sơ tổng hợp** khi nhập giờ sinh. Mỗi chính tinh còn có **luận theo từng cung** (14 sao × 12 cung = 168 ý nghĩa). An sao **tất định, đối chiếu nhiều nguồn & cách đồng cung kinh điển**; phần ý nghĩa là tham khảo.
...
- **So đôi lá số (Tử Vi):** an sao hai lá số rồi đối chiếu **Mệnh, cung Phu Thê và quan hệ địa chi năm sinh** — dữ kiện để cùng chiêm nghiệm, *không phải kết luận hợp/không hợp*.
...
npm test                        # chạy 134 kiểm thử logic (tests/run.mjs)
```
...
├── data/        tarot.js (78 lá) · numerology.js · tuvi.js · tuvidauso.js (lá số Tử Vi) · zodiac.js · iching.js (64 quẻ) · iching-text.js (Thoán/hào từ) · lunar.js · report.js · site.js
└── pages/       Home · Profile · Tarot · Numerology · TuVi · LaSoTuVi · Zodiac · TuongHop · IChing · Sources
tests/          run.mjs (npm test — 134 mốc)
```

## Đã kiểm thử
Mọi công thức đối chiếu mốc đã biết: 2026 = Bính Ngọ/Thiên Hà Thủy; **1/3/2000 = Mậu Ngọ** (Can Chi ngày); 16/6 = Song Tử; LP 22/10/1980 = 5; LP 13/4/1988 chạm nợ nghiệp 16; Kinh Dịch 64 quẻ với 64 mẫu nhị phân duy nhất; Sao hạn đối chiếu bảng 2026; ca biên Tết VN 1985 (≠ Tết TQ). Bộ test **npm test — 134 mốc, 0 fail**, gồm **test quét biên** (getZodiac/decan/zodiacCompat/lifePathCompat mọi cặp, Can Chi lặp 60 năm, castHexagram 60 lần) và **kiểm chứng đủ 64 Thoán + 384 hào từ Kinh Dịch**, **an sao Tử Vi Đẩu Số** (Mệnh/Cục/14 chính tinh/Tứ Hóa khớp ví dụ & cách đồng cung kinh điển; bảng độ sáng M/V/Đ/B/H đối chiếu khớp Miếu với HOROS). Build production sạch (Vite).
